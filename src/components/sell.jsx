  ...
  return (
    <div>
      <div className="pt-[120px] lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
          <p className="text-center py-[1rem] text-[#DE9C10]">Add A New Product</p>
          <div className="flex flex-col items-center">
            <form
              onSubmit={handleSubmit}
              className="w-[90%] bg-[#DE9C10] mb-[2rem] rounded-[10px] flex flex-col px-[1rem] pb-[2.5rem]"
            >
               <div
                onClick={() => {
              ...
              <input
                ...
                className="text-center bg-[#282828] text-[#DE9C10] mt-[2rem] border py-[0.5rem] rounded-[10px] items-center"
              />
            </form>
          </div>
        </div>
