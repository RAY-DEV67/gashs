...
import bag1 from "../assets/gasha.jpg";
...
//   }, [index, images.length]);
  ...
  return (
    <div className="lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%] bg-[#282828]">
      ...
      <Search />
      <div className="flex justify-between p-2 px-[1.5rem] mb-[1rem] text-[#282828] bg-[#DE9C10] font-bold rounded-[20px] heading">
